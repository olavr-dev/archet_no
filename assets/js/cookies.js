  ...
  if (!t.isInit) {
    var e = {
      ...
      extend: function(t, e) {
        for (var n in e)
          e.hasOwnProperty(n) &&
            (n in t && this.isPlainObj(t[n]) && this.isPlainObj(e[n]) ? this.extend(t[n], e[n]) : (t[n] = e[n]));
        return t;
      },
      ...
      (t.Popup = (function() {
        ...
        return (
                      ...
                      o &&
                        (function(e, n, i) {
                          ...
                          o &&
                            ...
                            (s[i + ' .wpcc-privacy,' + i + ' .wpcc-privacy:active,' + i + ' .wpcc-privacy:visited'] = [
                              'color: ' + o.text
                            ]),
                            r &&
                              ((s[i + ' .wpcc-btn'] = ['color: ' + r.text, 'background-color: ' + r.background]),
                              (s[i + ' .wpcc-btn:focus, ' + i + ' .wpcc-btn:hover'] = [
          ...
          (i.prototype.destroy = function() {
            this.onButtonClick &&
              this.element &&
              (this.element.removeEventListener('click', this.onButtonClick), (this.onButtonClick = null)),
              this.onButtonEnter &&
                this.element &&
                (this.element.removeEventListener('keyup', this.onButtonEnter), (this.onButtonEnter = null)),
          ...
          (i.prototype.open = function(e) {
            if (this.element)
              return this.isOpen() || (t.fading ? this.fadeIn() : (this.element.style.display = '')), this;
          }),
          (i.prototype.close = function() {
            if (this.element)
              return this.isOpen() && (t.fading ? this.fadeOut() : (this.element.style.display = 'none')), this;
          }),
          ...
          (i.prototype.fadeOut = function() {
            ...
            n &&
              ...
              e.hasClass(n, 'wpcc-invisible') ||
                (this.options.pushdown && (this.element.parentNode.style.maxHeight = ''),
...
window.addEventListener('load', function() {
  window.wpcc.init({
    ...
    position: 'bottom',
    content: {
      href: 'https://www.archetweb.no/privacy/cookies.html',
      message: 'Denne websiden bruker Cookies for å gjøre brukeropplevelsen din bedre.',
      link: 'Les mer',
      button: 'Ok'
    }
  });
